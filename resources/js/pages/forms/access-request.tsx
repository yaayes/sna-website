...
export default function AccessRequest() {
    ...
    return (
        <>
            ...
            <div className="flex min-h-screen items-center justify-center bg-linear-to-br from-[#e8f8f8] via-white to-[#f0f9e8] px-4 py-16">
                        ...
                        {wasSuccessful ? (
                            <div className="space-y-2 rounded-2xl border border-teal-200 bg-teal-50 p-6 text-center">
                                ...
                                <p className="text-sm text-teal-700">
                                    ...
                                    email, un lien d'accès valable 1 heure vous
                                    a été envoyé.
                                </p>
                            </div>
                        ) : (
