...
export default function PartenairePage() {
    ...
    const inputCls =
        'w-full rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm text-gray-900 transition focus:border-sna-green focus:ring-2 focus:ring-sna-green/30 focus:outline-none placeholder:text-gray-400';
