...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Nouveau coupon', href: admin.coupons.create() },
];
...
export default function CouponCreatePage() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Admin — Nouveau coupon" />
            <div className="mx-auto w-full max-w-2xl p-6">
                <form onSubmit={onSubmit} className="space-y-6 rounded-2xl border bg-white p-6">
                    <div>
                        <h1 className="text-2xl font-bold tracking-tight">Nouveau coupon</h1>
                        <p className="mt-1 text-sm text-muted-foreground">
                            Créez un code de réduction pour le formulaire d'adhésion.
                        </p>
                    </div>
